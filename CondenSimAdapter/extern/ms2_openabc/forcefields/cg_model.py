...
try:
    ...
    PlumedForce = None
import warnings
from CondenSimAdapter.extern.ms2_openabc.forcefields.rigid import createRigidBodies
from CondenSimAdapter.extern.ms2_openabc.utils import write_pdb, write_mmCIF
import sys
import os
